...
class DataAnalyzer:
    def __init__(self):
        ...
        self.cached_transl_countries = util.load_json(self.cached_transl_countries_path)
    ...
    def get_english_country_transl(self, country):
        ...
        if country in self.countries:
            ...
            util.dump_json(temp, self.cached_transl_countries_path, update=True)
